...
public class BinaryExpressionTree {
    ...
    public static String postfixFromInfix(String infix) throws IllegalArgumentException {
        ...
        for (int i = 0; i < infix.length(); i++) {
            ...
            else if(DIGITS.indexOf(infix.charAt(i)) != -1)
            {
                ...
                //if character that comes right after this digit is NOT a number, put white space in postfix
            ...
            throws IllegalArgumentException
    {
        ...
        {	//if it is a digit
            if(DIGITS.indexOf(postfix.charAt(i)) != -1) {
                String temp = "";
                		//while it is a digit- for numbers that are more than 1 digit. Like 45. Put 45 together in "temp"
    ...
    public static int valueOfExpressionTreeHelper (Position <String> p, LinkedBinaryTree<String> tree) {
